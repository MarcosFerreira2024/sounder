...
function PlaylistMusicSkeleton({ index }: { index: number }) {
  return (
    <div
      style={{ opacity: index / 10 + 0.05 }}
      className={`bg-neutral-950   border animate-pulse  border-neutral-800 rounded-2xl h-17.5 flex items-center justify-between px-3`}
    >
...
export default PlaylistMusicSkeleton;
