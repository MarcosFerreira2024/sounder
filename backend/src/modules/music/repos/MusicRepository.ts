...
import { IMusicRepository, musicQueryFilters, MusicWithCover } from "../interfaces/IMusicRepository";
...
class MusicRepository implements IMusicRepository {
    ...
    async updateMany(albumId: string, data: Partial<{ name: string; audio: string; artistId: string,albumId: string }>): Promise<void> { 
    ...
    async createMusic(data: { name: string; audio: string; artistId: string, lyrics: string,genres: string[], albumId: string}): Promise<Music> {
    ...
    async getMusics( search?: musicQueryFilters,page?: number, limit?: number): Promise<Music[]> {
    ...
    async updateMusic(musicId: string, data: Partial<{ name: string; audio: string; artistId: string; }>): Promise<Music> {
