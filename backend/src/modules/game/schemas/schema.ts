...
export const gamemodeId = z
  .uuid({ error: zodErrorMessages.invalid("gamemode Id") })
  .min(1, zodErrorMessages.required("Gamemode Id"));

export const mode = z
  .string()
  .min(1, zodErrorMessages.required("Game Mode Name"));
